    ...
    <>
      <section className="text-gray-600 body-font">
        ...
        <div className="lg:w-4/6 mx-auto">
            ...
            <Image src='/images/kouen.png' alt="Blog" className="object-cover object-center h-full w-screen" width={200} height={200} />
            </div>
            ...
            <div className="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                ...
                <h2 className="font-medium title-font mt-4 text-gray-900 text-lg">Haruki Sugiyama</h2>
